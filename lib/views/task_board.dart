                ...
                itemBuilder: (context, index) {
                  ...
                  return ListTile(
                    ...
                    onTap: (){
                      ...
                      ref.read(taskDetailtitleProvider.notifier).state = TextEditingController(text: task.title);
                      ref.read(taskDetailbodyProvider.notifier).state = TextEditingController(text: task.body);
                    Navigator.push(
                    context,
